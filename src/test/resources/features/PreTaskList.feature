...
Feature: Example Feature file using Cucumber
  ...
  Scenario: Pre Task List - GB Normal - T2 - ENS
    And I select GB on the office of departure page
  ...
  Scenario: Pre Task List - XI Simplified - T2F - EXS
  ...
  Scenario: Pre Task list - XI Normal - TIR - Both
    And I select XI on the office of departure page
    And I choose radio option Normal on the procedure type page
  ...
  Scenario: Pre Task List - GB Normal - T - No Security
    And I select GB on the office of departure page
    And I choose radio option Normal on the procedure type page
