...
Feature: Journey to test a draft departure in the Manage Transit Movements frontend
  ...
  Scenario: 01 User starts a departure declaration, signs out, then returns to continue the declaration on a subsequent login before deleting the draft
    ...
    Then I enter 1234567890 on the 'What is the Local Reference Number?' page
    ...
    Then I enter 1234567890 in the Search field on the 'Draft departure declarations' page
    And I should see the content Showing 1 result matching 1234567890 on the 'Draft departure declarations' page
    Then I click on the link for LRN 1234567890 on the 'Draft departure declarations' page
