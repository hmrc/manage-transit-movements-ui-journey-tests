...
Feature: End to end journey for Great Britain office of departure
  ...
  Scenario: 05 GB Normal - T1 - NO Safety and Security, Guarantees [0,3,5,9,R] - Office of Transit [Yes]
    And I choose radio option Normal on the procedure type page
    And I choose radio option T1 on the declaration type page
    And I choose radio option No security on the security type page
    And I submit on the CYA page
  ...
  #Route Details Transit -> Entry point is -> Add office of transit [Yes]
    ...
    When I select Belfast EPU (GB000142) on the office of transit page
    Then I should have Belfast EPU (GB000142) arrival time title on the office of transit add eta page
    When I choose radio option No on the office of transit add eta page
