...
#    And I click radio option Yes on the 'Are you sure you want to remove the (T2L) T2L?' page
    And I choose radio option Yes on the 'You have added 2 document' page
    ...
    And I click radio option Yes on the 'Are you sure you want to remove the (380) Commercial invoice - 98765 from this item?' document page
  ...
  - Container Ind 'No'
    ...
    And I select (235) on the 'Which document do you want to attach?' page
    And I click radio option No on the 'You have attached 1 document to this item' page
    And I sign out
