...
#    And I should see ERROR status for document details on the 'Declaration summary' page
#    And I should see ERROR status for items details on the 'Declaration summary' page
...
#    And I click the Change link for Do you know transit holder's EORI number or Trader Identification Number (TIN)? on the Trader details 'Check your answers' page
...
#    And I click the Change link for Do you want to add any transport equipment? on the Transport details 'Check your answers' page
...
#
#    And I click on the Edit document details link on the 'Declaration summary' page
...
#
#    And I click on the Edit items details link on the 'Declaration summary' page
