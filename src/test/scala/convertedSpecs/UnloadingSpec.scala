import ArrivalNotificationsStepDefSteps.{andIClickOnTheMakeUnloadingRemarksOnTheReviewUnloadingRemarksErrorsPage, andIClickOnTheXLinkForMRNXOnTheArrivalNotificationsPage, thenIShouldBeOnTheArrivalNotificationsPage, thenIshouldBeOnTheReviewUnloadingRemarksErrorsPage}
import CYAStepDefSteps.{andIclickTheChangeLinkForOnTheCheckYourAnswersPage, andIsubmitTheCheckYourAnswersPage}
  ...
  Feature("Submit unloading remarks with seals") {
    ...
    Scenario("03 - Unloading remarks attempt to use revised procedure, with changes to summary answers & add/remove comment & adds new seals and changes the check seals section from CYA page") {
      ...
      And("I click the More details link for house consignment 1 on the Enter the discrepancies between the transit movement and unloading permission page")
        ...
        givenIclickTheMoreDetailsLinkForHouseConsignmentOnTheEnterTheDiscrepanciesBetweenTheTransitMovementAndUnloadingPermissionPage("1")
    ...
    Scenario("05 - Trader is able to view unloading remarks with rejections and resubmit") {
      ...
      And("I click the Change link for Were there any discrepancies between the transit and unloading permission? on the Unloading Check your answers page")
        // Possible match (best=0.80)
        andIclickTheChangeLinkForOnTheCheckYourAnswersPage("Were there any discrepancies between the transit and unloading permission")
