...
class DepartureEndToEndGBP6Spec extends BaseSpec with GivenWhenThen {
  ...
  Feature("End to end journey for Great Britain office of departure") {
    ...
    Scenario(
      ...
      And("I choose to click on the Remove link on the 'You have added 2 transport authorisations page'")
      whenIchooseToClickOnXLinkOnTheYouHaveAddedXAuthorisationsPage("Remove", "2")

      And("I choose radio option Yes on the 'Are you sure you want to remove this TRD authorisation?' page")
      andIchooseRadioOptionXForTheAreYouSureYouWantToRemoveThisAuthorisationPage("Yes", "TRD")
      ...
      Then("I click the Add documents link on the Declaration summary page")
      thenIclickTheLinkOnTheDeclarationSummaryPage("Add documents")
