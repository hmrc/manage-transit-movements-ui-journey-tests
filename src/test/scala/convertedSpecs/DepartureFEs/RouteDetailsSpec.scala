...
class RouteDetailsSpec extends BaseSpec with GivenWhenThen {
  ...
  Feature("Route details Journey") {
    ...
    Scenario("01 Great Britain office of departure") {
      ...
      And("And I choose radio option Yes on the 'You have added 2 countries to the transit route' page")
      ...
      And("And I choose radio option No on the 'You have added 4 countries to the transit route' page")
      ...
      And("And I choose radio option No on the 'Do you want to add a time of arrival in Bastia port (FR000380)?' page")
      andIchooseRadioOptionXOnTheDoYouWantToAddATimeOfArrivalInXPage("No", "Bastia port (FR000380)")
      And("And I submit on the Check your answers section Office of transit page")
      andIsubmitOnTheCheckYourAnswersSectionXPage("Office of transit")
      And("And I choose to click on the Remove link on the 'You have added 2 offices of transit' page")
      ...
      And("And I choose radio option No on the 'Do you want to add a time of arrival in Brake (DE005301)?' page")
      andIchooseRadioOptionXOnTheDoYouWantToAddATimeOfArrivalInXPage("No", "Brake (DE005301)")
      And("And I submit on the Check your answers section Office of transit page")
      andIsubmitOnTheCheckYourAnswersSectionXPage("Office of transit")
      And("And I choose radio option No on the 'You have added 2 offices of transit' page")
      andIchooseRadioOptionXOnTheYouHaveAddedXOfficesOfTransitPage("Yes", "2")
      And("And I select Serbia on the 'Which country is the office of transit in?' page")
      andIselectOnTheWhichCountryIsTheOfficeOfTransitInPage("Serbia")
      And("And I select CI GRADINA (RS013277) on the 'Where in Serbia is the office of transit?' page")
      andIselectOnTheWhereInXIsTheOfficeOfTransitPage("CI GRADINA (RS013277)", "Serbia")
      And("And I choose radio option No on the 'Do you want to add a time of arrival in CI GRADINA (RS013277)?' page")
      ...
      And("And I choose radio option Yes on the 'Do you want to add a contact for the location of goods?' page")
      andIchooseRadioOptionXOnTheDoYouWantToAddAContactForTheLocationOfGoodsPage("Yes")
      And("And I enter Locator Joe on the 'Who is the contact for the location of goods?' page")
      andIenterOnTheWhoIsTheContactForTheLocationOfGoodsPage("Locator Joe")
      And("And I enter +432 1212 1212 on the 'What is the phone number for the location of goods’ contact?' page")
      ...
      And("And I enter AEFAT on the 'What is the UN LOCODE for the place of loading?' page")
      andIenterOnTheWhatIsTheUNLOCODEForThePlaceOfLoadingPage("AEFAT")
      And("And I choose radio option Yes on the 'Do you want to add extra information for the place of loading?' page")
      andIchooseRadioOptionXOnTheDoYouWantToAddExtraInformationForThePlaceOfLoadingPage("Yes")
      And("And I select United Kingdom on the 'In which country is the place of loading?' page")
      andIselectOnTheInWhichCountryIsThePlaceOfLoadingPage("United Kingdom")
      And("And I enter London on the 'Where in United Kingdom is the place of loading?' page")
      andIenterOnTheWhereInXIsThePlaceOfLoadingPage("London", "United Kingdom")
      And("And I choose radio option Yes on the 'Do you want to add a place of unloading?' page")
      andIchooseRadioOptionXOnTheDoYouWantToAddAPlaceOfUnloadingPage("Yes")
      And("And I choose radio option Yes on the 'Do you want to add a UN LOCODE for the place of unloading?' page")
      ...
      And("And I enter Milano on the 'Where in Italy is the place of unloading?' page")
      andIenterOnTheWhereInXIsThePlaceOfUnloadingPage("Milano", "Italy")
      And("And I submit on the Check your answers section Places of loading and unloading page")
      andIsubmitOnTheCheckYourAnswersSectionXPage("Places of loading and unloading")
      And("And I submit on the Check your answers section Route details page")
