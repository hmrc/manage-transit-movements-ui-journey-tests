...
class TransportDetailsSpec extends BaseSpec with GivenWhenThen {
  ...
  Feature("Transport details journey") {
    ...
    Scenario(
      ...
      andIchooseRadioOptionXOnTheBorderModeWhichIdentificationDoYouWantToUseForThisVehiclePage("Registration number of the road vehicle")
      ...
      andIselectOnTheWhatTypeOfAdditionalInformationDoYouWantToAddPage("20100 - Export from one EFTA country subject to restriction or export from the Union subject to restriction")
      ...
      And("I click radio option Yes on the 'Are you sure you want to remove this additional information from all items?' page")
    ...
    Scenario("02 Great Britain office of departure - No to optional") {
      ...
      andIchooseRadioOptionXOnTheAreTheGoodsBeingTransportedToAnotherCountryAfterTheEndOfThisTransitMovementPage("Not sure")
      ...
      andIchooseRadioOptionXOnTheBorderModeWhichIdentificationDoYouWantToUseForThisVehiclePage("registration number of the aircraft")
