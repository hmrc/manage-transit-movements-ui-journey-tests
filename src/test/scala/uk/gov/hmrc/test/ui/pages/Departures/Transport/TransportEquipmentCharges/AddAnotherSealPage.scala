...
object AddAnotherSealPage extends YesNoPage {
  ...
  override def title(args: String*): String = args match {
    case Seq("1")           => "You have added 1 seal - Departure declarations"
    case Seq(numberOfSeals) => String.format("You have added %s seals - Departure declarations", numberOfSeals)
