...
object HolderNamePage extends BasePage {

  val holderNameTitle = "What is the transit holder’s name? - Manage your transit movements - GOV.UK"

  def loadPage: this.type = {
    onPage(holderNameTitle)
    this
  }
