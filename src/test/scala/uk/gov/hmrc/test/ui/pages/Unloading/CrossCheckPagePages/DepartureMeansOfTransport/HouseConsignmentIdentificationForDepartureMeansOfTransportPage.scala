...
package uk.gov.hmrc.test.ui.pages.Unloading.CrossCheckPagePages.DepartureMeansOfTransport

import uk.gov.hmrc.test.ui.pages.RadioPage

object HouseConsignmentIdentificationForDepartureMeansOfTransportPage extends RadioPage {

  override def title(args: String*): String =
    String.format(
      "Which identification do you want to use for the departure means of transport in house consignment %s?",
      args: _*
    )
