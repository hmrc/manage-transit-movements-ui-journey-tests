...
@CucumberOptions(
  ...
  tags =
    "@departureGBe2e or @departureXIe2e or @departureGuaranteeDetails or @departureHub or @departureItemDetails or " +
      ...
      "@arrivalE2e or @cancellation or @managehub or @manageDraftDeparture or @unloading_remarks or @departureAmendment or @presentationNotificationIe15,@presentationNotificationIe13 or @UnloadingCrossCheck"
)
class RunnerForAll {}
