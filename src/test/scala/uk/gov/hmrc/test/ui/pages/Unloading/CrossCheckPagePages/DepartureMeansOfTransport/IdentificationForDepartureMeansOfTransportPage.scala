...
object IdentificationForDepartureMeansOfTransportPage extends RadioPage {

  override def title(args: String*): String = "Which identification do you want to use for the departure means of transport?"
