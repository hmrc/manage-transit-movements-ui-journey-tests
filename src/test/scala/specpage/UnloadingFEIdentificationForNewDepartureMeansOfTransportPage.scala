...
object UnloadingFEIdentificationForNewDepartureMeansOfTransportPage extends RadioPage {

  override def title(args: String*): String =
    "Which identification do you want to use for the new departure means of transport?"
