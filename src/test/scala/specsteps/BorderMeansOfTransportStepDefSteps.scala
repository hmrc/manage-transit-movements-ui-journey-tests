...
import specpage.Departures.Transport.BorderMeansOfTransport.*
...
object BorderMeansOfTransportStepDefSteps {
  ...
  def andIselectRadioOptionXOnTheAreYouSureYouWantToRemoveBorderMeansOfTransportXPage(
    answer: String,
  ...
  def whenIchooseRadioOptionXOnTheYouHaveAddedXBorderMeansOfTransportPage(
    answer: String,
