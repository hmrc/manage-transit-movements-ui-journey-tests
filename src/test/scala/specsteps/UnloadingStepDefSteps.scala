...
import specpage.*
import specpage.Departures.Items.PackagesTypeQuantityPage
...
object UnloadingStepDefSteps {
  ...
  def givenIclickTheMoreDetailsLinkForHouseConsignmentOnTheEnterTheDiscrepanciesBetweenTheTransitMovementAndUnloadingPermissionPage(
    index: String
  ): Unit =
    UnloadingFEConsignmentCrossCheckPage
      .loadPage()
  ...
  def andIchooseRadioOptionXOnTheWereThereAnyDiscrepanciesBetweenTheTransitMovementAndUnloadingPermissionPage(
    answer: String
  ): Unit =
  ...
  def givenIclickTheDocumentsLinkForDocumentsOnTheCrosscheckTheTransitWithThisDeclarationSummaryPage(
    index: String
  ): Unit =
    UnloadingFEConsignmentCrossCheckPage
      .loadPage()
  ...
  def andIclickTheChangeLinkForSubsectionOfSection(
  ...
  def andIclickTheLinkInHouseConsignmentSubsectionOfSection(
    changeLinkText: String,
    index: String,
    subSection: String,
    section: String
  ...
  def andIenterAdditionalReferenceOnTheWhatIsTheNewAdditionalReferenceNumberForItem1InHouseConsignment1Page(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheWhichIdentificationDoYouWantToUseForTheNewDepartureMeansOfTransportPage(
    answer: String
  ): Unit =
  ...
  def andIenterIdentificationNumberOnTheWhatIsTheIdentificationNumberForTheNewDepartureMeansOfTransportPage(
    answer: String
  ): Unit =
  ...
  def andIAddOnTheWhatTypeOfDocumentDoYouWantToAddForItemXInHouseConsignment1Page(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIselectOnTheWhatTypeOfDocumentDoYouWantToAddForHouseConsignmentXPage(
    answer: String,
    houseConsignmentIndex: String
  ): Unit =
  ...
  def andIenterReferenceNumberOnWhatIsTheDocumentsReferenceNumberForItemXInHouseConsignment1Page(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheDocumentsDoYouWantToAddAnyAdditionalInformationForThisDocumentPage(
    answer: String
  ): Unit =
  ...
  def andIenterAdditionalInformationOnDocumentsEnterTheAdditionalInformationForItemXInHouseConsignment1Page(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIaddAdditionalInformationOnDocumentsEnterTheAdditionalInformationInHouseConsignmentXPage(
    answer: String,
    houseConsignmentIndex: String
  ): Unit =
  ...
  def andIchooseToClickOnTheXLinkOnTheYouHaveAddedXDocumentstoAllItemsPage(
    sectionLink: String,
    numberOfDocumentsAdded: String
  ): Unit =
    UnloadingFEDocumentsAddAnotherDocumentsPage
  ...
  def andIchooseRadioOptionXOnTheDocumentsDoYouWantToAddTheTypeOfIdentificationForTheDepartureMeansOfTransportPage(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheWhichIdentificationDoYouWantToUseForTheDepartureMeansOfTransportPage(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheWhichIdentificationDoYouWantToUseForTheDepartureMeansOfTransportInHouseConsignmentXPage(
    answer: String,
    houseConsignmentIndex: String
  ): Unit =
  ...
  def andIselectOnTheWhatTypeOfAdditionalReferenceDoYouWantToAddForItemXInHouseConsignment1Page(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIchooseOnTheWhatTypeOfAdditionalReferenceDoYouWantToAddForHouseConsignmentXPage(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIenterAdditionalReferenceXOnTheWhatIsTheAdditionalReferenceNumberForItemXInHouseConsignment1Page(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIselectOnTheWhatTypeOfPackageAreYouUsingForItemXInHouseConsignment1Page(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIchooseToClickOnTheXLinkOnTheYouHaveAddedXDepartureMeansOfTransportPage(
    sectionLink: String,
    numberOfDeparturesAdded: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheDocumentsAreYouSureYouWantToRemoveDepartureMeansOfTransportPage(
    answer: String,
    removeCount: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheYouHaveAddedXDepartureMeansOfTransportPage(
    answer: String,
  ...
  def andIclickContinueYouHaveAppliedXItemToTransportEquipmentXPage(
  ...
  def andIchooseRadioOptionXOnTheCrossCheckYouHaveAddedXTransportEquipmentPage(
    answer: String,
    numberOfTransportEquipment: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheCrossCheckDoYouWantToAddAContainerIdentificationNumberForTheTransportEquipmentPage(
    answer: String
  ): Unit =
  ...
  def andIclickXOnYouHaveAddedXSealstoTransportEquipmentXPage(
    answer: String,
  ...
  def andIchooseRadioOptionXOnAreYouSureYouWantToRemoveThisSealFromTransportEquipmentXPage(
    answer: String,
    numberOfTransportEquipmentIncrementsInTitle: String
  ): Unit =
  ...
  def andIclickRadioOptionXOnTheYouHaveAddedXSealstoTransportEquipmentXPage(
    answer: String,
    numberOfTransportEquipmentSealInTitle: String,
    numberOfTransportEquipmentIncrementsInTitle: String
  ): Unit =
  ...
  def andIclickXOnYouHaveAppliedXItemToTransportEquipmentXPage(
    answer: String,
    numberOfTransportEquipmentSealInTitle: String,
    numberOfTransportEquipmentIncrementsInTitle: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheAreYouSureYouWantToRemoveThisItemFromTransportEquipmentPage(
    answer: String,
    removeCount: String
  ): Unit =
  ...
  def andIchooseToClickOnTheXLinkOnTheYouHaveAddedXTransportEquipmentPage(
    sectionLink: String,
    numberOfTransportEquipAdded: String
  ): Unit =
    UnloadingFEAddAnotherForTransportEquipmentPage
  ...
  def andIchooseRadioOptionXOnTheDocumentsAreYouSureYouWantToRemoveTransportEquipmentPage(
    answer: String,
    removeCount: String
  ): Unit =
  ...
  def andIclickRadioOptionXOnTheYouHaveAppliedXItemstoTransportEquipmentXPage(
    answer: String,
  ...
  def andIchooseRadioOptionXOnTheAreYouSureYouWantToRemoveTheGrossWeightFromItem1InHouseConsignment1Page(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheAreYouSureYouWantToRemoveTheNetWeightFromItem1InHouseConsignment1Page(
    answer: String
  ): Unit =
  ...
  def andIenterNumberOnWhatIsTheNewCustomsUnionAndStatisticsCUSCodeForItemInHouseConsignment1Page(
    answer: String,
    index: String
  ): Unit =
  ...
  def andIenterNumberOnWhatIsTheCustomsUnionAndStatisticsCodeForItemInHouseConsignmentPage(
    answer: String,
    itemIndex: String,
    hcIndex: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheAreYouSureYouWantToRemoveTheCommodityCodeFromItem1InHouseConsignment1Page(
    answer: String
  ): Unit =
  ...
  def andIenterNumberOnWhatIsTheNewCombinedNomenclatureCodeForItemInHouseConsignment1Page(
    answer: String,
    index: String
  ): Unit =
  ...
  def andIenterNumberOnWhatIsTheCombinedNomenclatureCodeForItemInHouseConsignment1Page(
    answer: String,
    index: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheAreYouSureYouWantToRemoveTheCombinedNomenclatureCodeFromItem1InHouseConsignment1Page(
    answer: String
  ): Unit =
  ...
  def andIclickRadioOptionXOnTheYouHaveAddedXItemsforHouseConsignmentXPage(
    answer: String,
  ...
  def andIenterXOnTheEnterTheDescriptionOfItemsInHouseConsignmentXPage(
    answer: String,
    numberOfItemInTitle: String,
    numberOfHouseConsignmentsInTitle: String
  ): Unit =
  ...
  def andIclickXOnYouHaveAddedXDocumentstoItemInHouseConsignment1Page(
    answer: String,
  ...
  def andIclickRadioOptionXOnTheAreYouSureYouWantToRemoveThisDocumentFromItemInHouseConsignment1Page(
    answer: String,
  ...
  def andIclickXOnHouseConsignmentDocumentYouHaveAddedXDocumentstoItemInHouseConsignment1Page(
    answer: String,
    numberOfDocumentsTitle: String,
    numberOfItemsInTitle: String
  ): Unit =
  ...
  def andIclickXOnAdditionalReferenceYouHaveAddedAdditionalReferencesforItemInHouseConsignment1Page(
    answer: String,
  ...
  def andIclickXOnTheYouHaveAddedAdditionalReferencesforItemInHouseConsignment1Page(
    answer: String,
    numberOfAdditionalRefTitle: String,
    numberOfItemsInTitle: String
  ): Unit =
  ...
  def andIenterXOnTheHowManyOfThisPackageAreYouUsingForItemXInHouseConsignment1Page(
    answer: String,
    itemIndex: String
  ): Unit =
  ...
  def andIclickXOnHouseConsignmentPackageYouHaveAddedXTypesofPackagesforItemInHouseConsignment1Page(
    answer: String,
  ...
  def andIclickXOnTheHouseConsignmentPackageYouHaveAddedXTypesofPackagesforItemInHouseConsignment1Page(
    answer: String,
    numberOfTypesInTitle: String,
    numberOfPackagesInTitle: String
  ): Unit =
  ...
  def andIclickRadioOptionXOnTheAreYouSureYouWantToRemoveThisPackageFromItemInHouseConsignment1Page(
    answer: String,
    numberOfItems: String
  ): Unit =
  ...
  def andIclickOptionXOnTheYouHaveAddedXItemsforHouseConsignmentXPage(
    answer: String,
    numberOfItemInTitle: String,
    numberOfHouseConsignmentsInTitle: String
  ): Unit =
  ...
  def andIclickRadioOptionXOnItemAreYouSureYouWantToRemoveItemFromHouseConsignment1Page(
    answer: String,
    numberOfItems: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheDoYouWantToAddADepartureMeansOfTransportForHouseConsignmentXPage(
    answer: String,
    HCNumber: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheYouHaveAddedXDepartureMeansOfTransportForHouseConsignment2Page(
    answer: String,
  ...
  def andIchooseRadioOptionXOnTheDoYouWantToAddAnyDocumentsForHouseConsignmentXPage(
    answer: String,
    HCNumber: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheYouHaveAddedXDocumentstoAllItemsInHouseConsignment2Page(
    answer: String,
    numberOfDocuments: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheDoYouWantToAddAnAdditionalReferenceForHouseConsignmentXPage(
    answer: String,
    HCNumber: String
  ): Unit =
  ...
  def andIclickRadioOptionXOnTheYouHaveAddedXAdditionalReferenceForHouseConsignment2Page(
    answer: String,
  ...
  def andIselectRadioOptionXOnTheYouHaveAddedXCountriestoTheTransitRoutePage(
    answer: String,
  ...
  def andIclickOnTheXLinkOnTheYouHaveAddedXCountriestoTheTransitRoutePage(
    sectionLink: String,
    numberOfCountries: String
  ): Unit =
    UnloadingFECountryOfRoutingAddAnotherPage
  ...
  def andIchooseRadioOptionXOnTheDoYouWantToAddAUniqueConsignmentReferenceForThisHouseConsignmentPage(
    answer: String
  ): Unit =
  ...
  def andIenterOnTheWhatIsTheUniqueConsignmentReferenceForHouseConsignmentPage(
    answer: String,
    houseConsignmentIndex: String
  ): Unit =
  ...
  def andIenterReferenceOnTheWhatIsTheUniqueConsignmentReferenceForItemInHouseConsignment1Page(
    answer: String,
    index: String
  ): Unit =
