...
object PresentationNotificationStepDefSteps {
  ...
  def andIchooseRadioOptionXOnThePresentationDoYouWantToAddAnAdditionalIdentifierForTheLocationOfGoodsPage(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnThePresentationDoYouWantToAddExtraInformationForThePlaceOfLoadingPage(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnThePresentationAreYouUsingAnyShippingContainersToTransportTheGoodsPage(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioXOnThePresentationInlandModeWhichIdentificationDoYouWantToUseForThisVehiclePage(
    answer: String
  ): Unit =
  ...
  def whenIchooseRadioXOnThePresentationYouHaveAddedXBorderMeansOfTransportPage(
    answer: String,
    numberOfBorderMeansInTitle: String
  ): Unit =
  ...
  def andIclickRadioXOnTheAreYouSureYouWantToRemoveBorderMeansOfTransportXPage(
    answer: String,
    borderMeansOfTransportNumber: String
  ): Unit =
  ...
  def andIclickTheXLinkOnTheYouHaveAddedXBorderMeansOfTransportPage(
    sectionLink: String,
  ...
  def whenIchooseRadioXOnThePresentationYouHaveAddedXSealPage(
    answer: String,
    numberOfBorderMeansInTitle: String
  ): Unit =
  ...
  def andIchooseRadioXOnThePresentationYouHaveAppliedXItemsToTransportEquipmentXPage(
    answer: String,
  ...
  def andIclickTheXLinkOnTheYouHaveAppliedXItemToTransportEquipmentXPage(
    answer: String,
    numberOfTransportEquipmentItemsInTitle: String,
    numberOfTransportEquipmentIncrementsInTitle: String
  ): Unit =
  ...
  def andIclickTheXLinkOnThePresentationYouHaveAddedXTransportEquipmentPage(
    sectionLink: String,
  ...
  def andIchooseRadioOptionXForTheAreYouSureYouWantToRemoveThisItemFromTransportEquipmentPage(
    answer: String,
    numberOfTransportEquipmentIncrementsInTitle: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnThePresentationYouHaveAddedXTransportEquipmentPage(
    answer: String,
    numberOfTransportEquipmentIncrementsInTitle: String
  ): Unit =
    PresentationNotificationAddAnotherTransportEquipmentPage
  ...
  // ^(?:I )?click the (.*) link on the presentation 'You have added (.*) transport equipment' page$
  def andIclickTheXLinkOnTheAddPresentationYouHaveAddedXTransportEquipmentPage(
    answer: String,
    numberOfTransportEquipment: String
  ): Unit =
    PresentationNotificationAddAnotherTransportEquipmentPage
  ...
  def andIclickRadioOptionXOnThePresentationAreYouSureYouWantToRemoveTransportEquipmentXPage(
    answer: String,
    sealIdNumber: String
  ): Unit =
  ...
  def andIclickTheXLinkOnThePresentationYouHaveAddedXDepartureMeansOfTransportPage(
    answer: String,
  ...
  def andIchooseRadioOptionXOnThePresentationYouHaveAddedXDepartureMeansOfTransportPage(
    answer: String,
    numberOfDepartureMeans: String
  ): Unit =
    PresentationNotificationAddAnotherDepartureMeansPage
  ...
  def andIchooseRadioOptionXOnThePresentationDepartureMeansOfTransportWhichIdentificationDoYouWantToUseForTheDepartureMeansOfTransportPage(
    answer: String
  ): Unit =
  ...
  def andIenterRegistrationNumberOnThePresentationWhatIsTheIdentificationNumberForTheDepartureMeansOfTransportPage(
    answer: String
  ): Unit =
  ...
  def andIchooseRadioOptionXOnTheAreYouSureYouWantToRemoveDepartureMeansOfTransportXPage(
    answer: String,
    numberOfDepartureMeans: String
  ): Unit =
